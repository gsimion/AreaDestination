   ...
   public class Destination<T> : IDestination<T> where T : IComparable
   {
      ...
      public override string ToString()
      {
         ...
         else
         {
            ...
            string res = compatAreas.Aggregate(sb, (builder, area) => builder.Append(area.ToString()).Append(Global.Sep)).ToString().TrimEnd(new char[] { Global.Sep });
            return res;
         }
      }
   }
