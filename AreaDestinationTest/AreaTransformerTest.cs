...
namespace AreaDestinationTest
{
   ...
   public class AreaTransformerTest
   {
      ...
      {
         List<string> AreaList = AreaTransformer.GetAreasFromString<string>("0", ';', '-', AreaTransformer.ParsingMode.EatChildReturnRanges);
      ...
      {
         List<string> AreaList = AreaTransformer.GetAreasFromString<string>("0", ';', '-', AreaTransformer.ParsingMode.EatChildReturnSingleDigits);
      ...
      {
         List<string> AreaList = AreaTransformer.GetAreasFromString<string>("0", ';', '-', AreaTransformer.ParsingMode.PreserveChildReturnRanges);
      ...
      {
         List<string> AreaList = AreaTransformer.GetAreasFromString<string>("0", ';', '-', AreaTransformer.ParsingMode.PreserveChildReturnSingleDigits);
      ...
      {
         foreach (var p in Enum.GetValues(typeof(AreaTransformer.ParsingMode)))
         {
            AreaTransformer_StringToDigitLongAreaCodes((AreaTransformer.ParsingMode)p);
         }
      }

      private void AreaTransformer_StringToDigitLongAreaCodes(AreaTransformer.ParsingMode ParsingMode)
      {
      ...
      public void AreaTransformer_StringToDigitMakeCompact()
      {
         foreach (var p in Enum.GetValues(typeof(AreaTransformer.ParsingMode)))
         {
            AreaTransformer_StringToDigitMakeCompact((AreaTransformer.ParsingMode)p);
         }
      }

      private void AreaTransformer_StringToDigitMakeCompact(AreaTransformer.ParsingMode ParsingMode)
      {
         bool bExpectedEatingUpChildren = (ParsingMode == AreaTransformer.ParsingMode.EatChildReturnRanges || ParsingMode == AreaTransformer.ParsingMode.EatChildReturnSingleDigits);
         ...
         int iExpectedCount = bExpectedEatingUpChildren ? 1 : ParsingMode == AreaTransformer.ParsingMode.PreserveChildReturnSingleDigits ? 9 : 2;
      ...
      {
         List<string> AreaList = AreaTransformer.GetAreasFromString<string>("11,110-117", ',', '-', AreaTransformer.ParsingMode.PreserveChildReturnRanges);
         List<string> ExpectedSequence = new List<string>(new string[] { "11", "110-117" });
         Assert.IsTrue(ExpectedSequence.SequenceEqual(AreaList));

         AreaList = AreaTransformer.GetAreasFromString<string>("11,110-117", ',', '-', AreaTransformer.ParsingMode.PreserveChildReturnSingleDigits);
      ...
      public void AreaTransformer_CanConvertInBothDirectionCorrectly()
      {
         foreach (var p in Enum.GetValues(typeof(AreaTransformer.ParsingMode)))
         {
            AreaTransformer_CanConvertInBothDirectionCorrectly((AreaTransformer.ParsingMode)p);
         }
      }

      private void AreaTransformer_CanConvertInBothDirectionCorrectly(
AreaTransformer.ParsingMode ParsingMode)
      {
         char chSep = '+';
         char chDel = '&';
         ...
         string sActualAreaString = AreaTransformer.TransformAreaDigitsToString((new int[] { 220, 221, 222, 223, 224, 225, 226, 227, 228, 229, 110, 111, 112, 113, 114, 115, 116, 117 })
            .Select(x => x.ToString()).ToList(), chSep, chDel);
         ...
         switch (ParsingMode)
         {
            case AreaTransformer.ParsingMode.EatChildReturnRanges:
            case AreaTransformer.ParsingMode.PreserveChildReturnRanges:
      ...
      public void AreaTransformer_StringToDigitMakeCompactWithSpecialRange09()
      {
         foreach (var p in Enum.GetValues(typeof(AreaTransformer.ParsingMode)))
         {
            if (((int)p).Equals((int)AreaTransformer.ParsingMode.PreserveChildReturnRanges))
               continue;
            AreaTransformer_StringToDigitMakeCompactWithHeadingZeroes((AreaTransformer.ParsingMode)p);
         }
      }
...
AreaTransformer.ParsingMode ParsingMode)
      ...
      private void AreaTransformer_StringToDigitMakeCompactWithHeadingZeroes(AreaTransformer.ParsingMode ParsingMode)
{
   bool bPrintRanges = (ParsingMode == AreaTransformer.ParsingMode.EatChildReturnRanges || ParsingMode == AreaTransformer.ParsingMode.PreserveChildReturnRanges);
   ...
   if (ParsingMode == AreaTransformer.ParsingMode.PreserveChildReturnRanges)
   {
   ...
   Assert.IsTrue(ExpectedSequence.SequenceEqual(AreaList));
      ...
      {
         List<string> AreaList_ECSD = AreaTransformer.GetAreasFromString<string>("1, 2 ,3 -5", ',', '-', AreaTransformer.ParsingMode.EatChildReturnSingleDigits);
         List<string> AreaList_PCSD = AreaTransformer.GetAreasFromString<string>("1, 2 ,3 -5", ',', '-', AreaTransformer.ParsingMode.PreserveChildReturnSingleDigits);
      ...
      {
         List<string> AreaList_ECSD = AreaTransformer.GetAreasFromString<string>("1+2 +3L5", '+', 'L', AreaTransformer.ParsingMode.EatChildReturnSingleDigits);
         List<string> AreaList_PCSD = AreaTransformer.GetAreasFromString<string>("1+2 +3L5", '+', 'L', AreaTransformer.ParsingMode.PreserveChildReturnSingleDigits);
      ...
      {
         List<string> AreaList = AreaTransformer.GetAreasFromString<string>("1; 2 ;3-5; 4-675", ';', '-', AreaTransformer.ParsingMode.EatChildReturnSingleDigits);
      ...
      {
         AreaTransformer.GetAreasFromString<string>("F;2", ';', '-', AreaTransformer.ParsingMode.EatChildReturnRanges);
      }
      ...
      {
         List<string> AreaList = AreaTransformer.GetAreasFromString<string>(String.Empty, ',', '-', AreaTransformer.ParsingMode.EatChildReturnRanges);
      ...
      {
         List<string> AreaList = AreaTransformer.GetAreasFromString<string>(null, ',', '-', AreaTransformer.ParsingMode.PreserveChildReturnRanges);
      ...
      {
         AreaTransformer.GetAreasFromString<string>("343542326546-1", ',', '-', AreaTransformer.ParsingMode.EatChildReturnSingleDigits);
      }
      ...
      {
         AreaTransformer.GetAreasFromString<string>("34-1", ',', '-', AreaTransformer.ParsingMode.PreserveChildReturnRanges);
      }
      ...
      {
         AreaTransformer.GetAreasFromString<string>("3434-1", ',', '-', AreaTransformer.ParsingMode.EatChildReturnSingleDigits);
      }
      ...
      {
         List<string> AreaList = AreaTransformer.GetAreasFromString<string>("1-123456789", ',', '-', AreaTransformer.ParsingMode.EatChildReturnSingleDigits);
      ...
      {
         List<string> AreaList = AreaTransformer.GetAreasFromString<string>("1, 2 ,3-5", ',', '-', AreaTransformer.ParsingMode.EatChildReturnSingleDigits);
      ...
      {
         AreaTransformer.GetAreasFromString<string>("1-2-3", ';', '-', AreaTransformer.ParsingMode.PreserveChildReturnRanges);
      }
      ...
      {
         AreaTransformer.GetAreasFromString<string>("3-1", ';', '-', AreaTransformer.ParsingMode.EatChildReturnRanges);
      }
      ...
      {
         List<string> AreaList = AreaTransformer.GetAreasFromString<string>("4-62; 688-8", ';', '-', AreaTransformer.ParsingMode.EatChildReturnSingleDigits);
      ...
      {
         List<string> AreaList = AreaTransformer.GetAreasFromString<string>("4-62; 688-8", ';', '-', AreaTransformer.ParsingMode.EatChildReturnRanges);
      ...
      public void AreaTransformer_DigitsToStringWithDelimiters()
      {
         ...
         string sAreaString = AreaTransformer.TransformAreaDigitsToString(AreaList, ',', '+');
      ...
      public void AreaTransformer_DigitsToStringEmptyInput()
      {
         ...
         sAreaString = AreaTransformer.TransformAreaDigitsToString(null, ';', '-');
         Assert.AreEqual<string>("", sAreaString);
      }
      ...
      public void AreaTransformer_BreakoutDigitsToStringWithAreaCodeStartsWith0()
      {
         ...
         string sAreaString = AreaTransformer.TransformAreaDigitsToString(BreakoutList, ';', '-', false);
      ...
      public void AreaTransformer_DigitsToStringRowsWithDelimiters()
      {
         ...
         string sAreaString = AreaTransformer.TransformAreaDigitsToString(Areas.Select(), "AREA", ',', '+');
      ...
      public void AreaTransformer_DigitsToStringRowsWrongType()
      {
         ...
         string sAreaString = AreaTransformer.TransformAreaDigitsToString(Areas.Select(), "DATE", ';', '-');
      ...
      public void AreaTransformer_DigitsToStringRowsEmptyInput()
      {
         ...
         // Rows are nothing
         sAreaString = AreaTransformer.TransformAreaDigitsToString(null, "AREA", ';', '-');
         Assert.AreEqual<string>("", sAreaString);

         // Column string is empty
         sAreaString = AreaTransformer.TransformAreaDigitsToString(Areas.Select(), "", ';', '-');
         Assert.AreEqual<string>("", sAreaString);

         // Column is nothing
         DataColumn Column = null;
         sAreaString = AreaTransformer.TransformAreaDigitsToString(Areas.Select(), Column, ';', '-');
         Assert.AreEqual<string>("", sAreaString);

         // Column is not part of the table
         // Need to send in some rows, otherwise it will not reach the point to check this
         Areas.Rows.Add("1");
         sAreaString = AreaTransformer.TransformAreaDigitsToString(Areas.Select(), "COLUMN_NOT_PART_OF_ROWS", ';', '-');
         Assert.AreEqual<string>("", sAreaString);
      }
      #endregion
   }
